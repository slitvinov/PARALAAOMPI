...
void MatVecMultiplication(int mynode, int numnodes, int N,
                          std::complex<double> **A, std::complex<double> *x,
...
void ApplyPreconditioner(int mynode, int numnodes, int N, int L,
